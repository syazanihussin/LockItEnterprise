...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        <a class="navbar-brand" href="index.html">LOCKIT</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            ...
            <p class="tagline">The one and only solution for any kind of mobila app and WebPage landing needs. Just change the screenshots and texts and you are good to go. </p>
        </div>
    ...
    <div class="section light-bg" id="features">
        <div class="container">
            <div class="section-title">
                ...
                <h3>Benefits? Of course you will have it!</h3>
            </div>
                    ...
                    <div class="card features">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="card-title">Enhanced User-Experience</h4>
                                    <p class="card-text">Beautiful interfaces,and easy to understand,what you could ask more? </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="list-unstyled ui-steps">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>take some time in registering your personal info so that we will know who you are! </p>
                            </div>
                        </li>
                        <li class="media my-4">
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <h5>Monitor Your Devices!</h5>
                                <p>Now your devices are up and running and keep your house in surveillance!</p>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class="section light-bg" id="gallery">
        <div class="container">
            <div class="section-title">
                <small>PACKAGE GALLERY</small>
                <h3>LockIt! Package Device</h3>
            </div>
        ...
        <div class="container">
            ...
            <div class="card-deck">
                <div class="card pricing">
                    <div class="card-head">
                        <small class="text-primary">INDIVIDUAL PURCHASE</small>
                        <span class="price">RM100<sub>/month</sub></span>
                    </div>
                    <ul class="list-group list-group-flush">
                        <div class="list-group-item">2 LockEye</div>
                        <div class="list-group-item">10 LockSense</div>
                        <div class="list-group-item">10 GB Storage</div>
                        <div class="list-group-item">Free Installation</div>
                        <div class="list-group-item">Free Minor Maintenance</div>
                    </ul>
                    <div class="card-body">
                ...
                <div class="card pricing popular">
                    <div class="card-head">
                        <small class="text-primary">GROUP PURCHASE</small>
                        <span class="price">RM270<sub>/month</sub></span>
                    </div>
                    <ul class="list-group list-group-flush">
            ...
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    ...
                    <div class=" d-block d-sm-inline-block">
                        <p class="mb-2">
                            <span class="ti-email mr-2"></span> <a class="mr-4" href="mailto:support@mobileapp.com">support@LockIt.com</a>
                        </p>
                    </div>
                    <div class="d-block d-sm-inline-block">
                        <p class="mb-0">
                            <span class="ti-headphone-alt mr-2"></span> <a href="tel:">03 - 8922 8922</a>
                        </p>
                    </div>
    ...
    <footer class="my-5 text-center">
        ...
        <p class="mb-2"><small>COPYRIGHT © 2017. ALL RIGHTS RESERVED. LockIt! BY <a href="https://colorlib.com">Someville</a></small></p>
    ...
    <div class="nav-menu fixed-top">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        <a class="navbar-brand" href="index.jsp">LOCKIT</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item"> <a class="nav-link active" href="#home">HOME <span class="sr-only">(current)</span></a> </li>
                                <li class="nav-item"> <a class="nav-link" href="#features">FEATURES</a> </li>
...
<!-----------------------------package info---------------------------------------------------------------------------->
    ...
    <div class="section" id="pricing">
        <div class="container">
            ...
            <div class="card-deck">
                ...
                <div class="card pricing popular">
                    <div class="card-head">
                        <small class="text-primary">GROUP PURCHASE (3 HOUSES)</small>
                        <span class="price">RM270<sub>/month</sub></span>
                    </div>
                    <ul class="list-group list-group-flush">
                        <div class="list-group-item">2 LockEye/House</div>
		...
		<form name="myForm" action="./registerServlet"  onSubmit="return validateForm()" method="post">
            <div class="row">
				...
				<div class="col-md-12 d-flex ">
					<div class="media-body">
						<div class="pull-right">
							<button type="submit" name="submitRegister" class="btn btn-primary btn-lg" required="required" value="REGISTER">REGISTER</button>
						</div>
					</div>
				</div>
            </div>
    ...
    <footer class="my-5 text-center">
        <!-- Copyright removal is not prohibited! -->
        <p class="mb-2"><small>COPYRIGHT © 2018. ALL RIGHTS RESERVED. LockIt! BY <a href="https://colorlib.com">Syahmiez</a></small></p>
